...
Only requiring some minor changes is jango.cpp.
...
Changes to jango.cpp
----------------------
jango.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

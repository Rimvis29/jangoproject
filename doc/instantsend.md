...
This mechanism has been integrated into Bitcore-Node-Jango which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/jangocoin/insight-api-jango#web-socket-api](https://github.com/jangocoin/insight-api-jango#web-socket-api) 
* API: [https://github.com/jangocoin/insight-api-jango#instantsend-transactions](https://github.com/jangocoin/insight-api-jango#instantsend-transactions) 
...
By default, the Jango Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Jango Core daemon:

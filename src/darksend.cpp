...
{
    if(fLiteMode) return; // ignore all Jango related functionality
...
/*
    ...
    allow endless transaction that would bloat Jango and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("jango-privatesend");

/* src/config/jango-config.h.  Generated from jango-config.h.in by configure.  */
/* src/config/jango-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Jango Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Jango Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/Jango/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Jango Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Jango Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "jangocore"

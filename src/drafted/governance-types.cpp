...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "JangoNetwork") type = JangoNetwork;
    if(strType == "JangoNetworkVariable") type = JangoNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == JangoNetwork) s = "JangoNetwork";
    if(type == JangoNetworkVariable) s = "JangoNetworkVariable";

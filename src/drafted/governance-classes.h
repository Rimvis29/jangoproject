 ...
 *
 *   // network
 *   CJangoNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.jangocoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CJangoNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: JangoNetwork
// //   -- signature requirements : Key1(User)
// class CJangoNetworkVariable : public CGovernanceObject
// {
// private:

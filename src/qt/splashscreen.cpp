    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Jango Core");
    ...
    QString copyrightTextJango   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Jango Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextJango);

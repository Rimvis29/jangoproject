    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Jango Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Jango Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  jango-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Jango in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an jangotive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 JNG, 0.1 JNG, 1 JNG and 10 JNG -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://jangocoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://jangocoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Jango Core is shutting down...") + "<br /><br />" +

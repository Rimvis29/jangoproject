    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Jango Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Jango address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and jango: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Jango Core"), this);
    aboutAction->setStatusTip(tr("Show information about Jango Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Jango Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Jango addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Jango addresses"));
    ...
    openAction->setStatusTip(tr("Open a jango: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Jango Core help message to get a list with possible Jango Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Jango Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Jango network", "", count));
}
...
{
    QString strTitle = tr("Jango Core"); // default title

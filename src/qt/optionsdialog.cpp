    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("JNG-light"), QVariant("light"));
    ui->theme->addItem(QString("JNG-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("JNG-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("JNG-traditional"), QVariant("trad"));
